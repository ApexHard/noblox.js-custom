...
// Define
function getRankInGroup(groupId, userId, bool=false) {
  ...
  return http({ url: `//groups.roblox.com/v2/users/${userId}/groups/roles`, options: { json: true } }).then((body) => {
    ...
    return groupObject ? (bool ? groupObject.role : parseInt(groupObject.role.rank)) : 0
  })
}
...
exports.func = function (args) {
  ...
  return cache.wrap('Rank', id, function () {
    return getRankInGroup(args.group, id, args?.boolean || false)
  })
}
